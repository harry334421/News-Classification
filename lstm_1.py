...
from keras.layers import (Bidirectional, CuDNNLSTM, Dense, Dropout, Embedding,
                          Flatten, GlobalAveragePooling1D, GlobalMaxPool1D,
                          GlobalMaxPooling1D, Input, SpatialDropout1D,
                          concatenate)
...
train = pd.read_csv("G:/Python/LSTM_Class/data/train.csv")
test = pd.read_csv("G:/Python/LSTM_Class/data/test.csv")
...
news_path = 'G:/Python/GoogleNews-vectors-negative300.bin'
